...
<html>
<head>
    <title>SD17313 - Thêm Mới Nhân Viên</title>
...
<div class="container">
    <sf:form action="${action}" method="post"
        ...
        <div>
            <label>Họ Tên</label>
            <div>
                <sf:input path="hoTen" class="form-control"/>
                <sf:errors path="hoTen"/>
            </div>
        </div>
        ...
        <div>
            ...
            <div>
                <sf:select path="idCuaHang">
                    <c:forEach var="a" items="${cuaHangList}">
        ...
        <div>
            ...
            <div>
                <sf:select path="idChucVu">
                    <c:forEach var="a" items="${chucVuList}">
                        <sf:option value="${a.id}">${a.ten}</sf:option>
                    </c:forEach>
                </sf:select>
            </div>
        ...
        <div>
            ...
            <div>
                <sf:input type="password" path="matKhau" class="form-control"/>
        ...
        <div>
            ...
            <div>
                <sf:radiobutton value="1" label="Đang làm" path="trangThai" checked="true"/>
